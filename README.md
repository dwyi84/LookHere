...
- **Menu Bar Settings (SwiftUI)** — toggle the circle and laser independently, pick from preset ring colors, and tune radius, opacity, and line thickness — all applied **live** with a built-in preview.
- **Global Hotkey** — press `⇧⌘L` anywhere to toggle the circle, or record your own shortcut right from the menu.
